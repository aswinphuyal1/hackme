...
//   return (
//     <div className="p-8 bg-gray-50 dark:bg-gray-800 rounded-lg shadow-inner min-h-[500px] flex items-center justify-center">
...
// // Crop Detection Content Component
// const CropDetectionContent = () => {
//   return (
//     <div className="p-8 bg-green-50 dark:bg-green-800 rounded-lg shadow-inner min-h-[500px] flex items-center justify-center">
